...
create index IX_C2514F0 on oshs_payment (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_40CE1772 on oshs_payment (uuid_[$COLUMN_LENGTH:75$], groupId);
