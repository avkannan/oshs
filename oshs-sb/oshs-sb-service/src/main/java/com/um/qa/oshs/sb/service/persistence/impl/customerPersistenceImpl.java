...
import com.um.qa.oshs.sb.model.impl.customerImpl;
import com.um.qa.oshs.sb.model.impl.customerModelImpl;
...
public class customerPersistenceImpl
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			customerModelImpl.getUuid(), customerModelImpl.getGroupId()
		};

		finderCache.putResult(
			_finderPathCountByUUID_G, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, customerModelImpl, false);
	}
	...
	public customer updateImpl(customer customer) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {
				customerModelImpl.getUuid(), customerModelImpl.getCompanyId()
			};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			customerModelImpl.DISPLAYNAME_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.um.qa.oshs.sb.model.customer"),
			true);
	}
