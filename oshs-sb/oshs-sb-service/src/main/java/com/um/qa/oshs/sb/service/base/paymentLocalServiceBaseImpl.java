...
import com.um.qa.oshs.sb.service.paymentLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.um.qa.oshs.sb.service.impl.paymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.um.qa.oshs.sb.service.impl.paymentLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class paymentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements paymentLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>paymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.um.qa.oshs.sb.service.paymentLocalServiceUtil</code>.
	 */
	...
	public payment createpayment(long orderID) {
		return paymentPersistence.create(orderID);
	}
	...
	public payment deletepayment(long orderID) throws PortalException {
		return paymentPersistence.remove(orderID);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			payment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return paymentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return paymentPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public payment fetchpayment(long orderID) {
		return paymentPersistence.fetchByPrimaryKey(orderID);
	}
	...
	public payment fetchpaymentByUuidAndGroupId(String uuid, long groupId) {
		return paymentPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public payment getpayment(long orderID) throws PortalException {
		return paymentPersistence.findByPrimaryKey(orderID);
	}
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<payment>() {

				@Override
				public void performAction(payment payment)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, payment);
				}
	...
	public List<payment> getpaymentsByUuidAndCompanyId(
		...
		return paymentPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<payment> getpaymentsByUuidAndCompanyId(
		...
		return paymentPersistence.findByUuid_C(
	...
	public payment getpaymentByUuidAndGroupId(String uuid, long groupId)
		...
		return paymentPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			paymentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		paymentLocalService = (paymentLocalService)aopProxy;
	}
