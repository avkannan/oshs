...
public interface paymentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link paymentLocalServiceUtil} to access the payment local service. Add custom service methods to <code>com.um.qa.oshs.sb.service.impl.paymentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public payment deletepayment(long orderID) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public payment fetchpayment(long orderID);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public payment fetchpaymentByUuidAndGroupId(String uuid, long groupId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public payment getpayment(long orderID) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public payment getpaymentByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<payment> getpaymentsByUuidAndCompanyId(
