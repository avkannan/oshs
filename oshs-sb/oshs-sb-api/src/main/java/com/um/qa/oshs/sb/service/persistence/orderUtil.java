...
public class orderUtil {
	 ...
	 */
	public static List<order> findByUuid(
	 ...
	 */
	public static order findByUuid_First(
			String uuid, OrderByComparator<order> orderByComparator)
		throws com.um.qa.oshs.sb.exception.NoSuchorderException {
	 ...
	 */
	public static order fetchByUuid_First(
		String uuid, OrderByComparator<order> orderByComparator) {
	 ...
	 * @throws NoSuchorderException if a matching order could not be found
	 */
	public static order findByUuid_Last(
			String uuid, OrderByComparator<order> orderByComparator)
		throws com.um.qa.oshs.sb.exception.NoSuchorderException {
	 ...
	 */
	public static order fetchByUuid_Last(
		String uuid, OrderByComparator<order> orderByComparator) {
	 ...
	 */
	public static order[] findByUuid_PrevAndNext(
	 ...
	 * @return the matching order, or <code>null</code> if a matching order could not be found
	 */
	public static order fetchByUUID_G(
	 ...
	 * @return the range of matching orders
	 */
	public static List<order> findByUuid_C(
	 ...
	 * @throws NoSuchorderException if a matching order could not be found
	 */
	public static order findByUuid_C_First(
	 ...
	 * @return the first matching order, or <code>null</code> if a matching order could not be found
	 */
	public static order fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<order> orderByComparator) {
	 ...
	 * @throws NoSuchorderException if a matching order could not be found
	 */
	public static order findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<order> orderByComparator)
		throws com.um.qa.oshs.sb.exception.NoSuchorderException {
	 ...
	 * @return the last matching order, or <code>null</code> if a matching order could not be found
	 */
	public static order fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<order> orderByComparator) {
	 ...
	 * @throws NoSuchorderException if a order with the primary key could not be found
	 */
	public static order[] findByUuid_C_PrevAndNext(
